...
WebUI.click(findTestObject('Control Ensayes/Flotacion/bulk/bulk'))

WebUI.click(findTestObject('Control Ensayes/Flotacion/bulk/bulk-cap'))
...
for (def rowNum = 1; rowNum <= findTestData('Data Files/Control de ensayes/La parrilla/Flotacion/Ag-Au/AgAu').getRowNumbers(); rowNum++) {
    ...
    WebUI.setText(findTestObject('Control Ensayes/Flotacion/bulk/Humedad'), findTestData('Data Files/Control de ensayes/La parrilla/Flotacion/Ag-Au/AgAu').getValue(
            2, rowNum))

    WebUI.setText(findTestObject('Control Ensayes/Flotacion/bulk/Humedas'), findTestData('Data Files/Control de ensayes/La parrilla/Flotacion/Ag-Au/AgAu').getValue(
            3, rowNum))
